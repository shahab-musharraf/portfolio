...
export const LinksContainer = () => (
  ...
  >
    ...
    <motion.li className="rounded-full flex justify-center items-center p-2 md:p-3 bg-black" variants={item} >
        <Link target="_blank" href={'https://www.geeksforgeeks.org/user/shahab_musharraf/'} className="hover:scale-105 hover:rotate-6 "><FaCode className="text-xl md:text-2xl lg:text-3xl text-white font-bold" /></Link>
    </motion.li>
    <motion.li className="item flex justify-center items-center p-2 md:p-3" variants={item} >
        <Link target="_blank" href={'https://x.com/shahab_siddiq_?t=creLLH2JMil8dvuvoCP9JA&s=09'} className="hover:scale-105 hover:rotate-6"><BsTwitterX className="text-xl md:text-2xl lg:text-3xl" /></Link>
    </motion.li>
  </motion.ul>
);
